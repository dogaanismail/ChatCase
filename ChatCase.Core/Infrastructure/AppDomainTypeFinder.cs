...
{
    /// <summary>
    /// A class that finds types needed by system by looping assemblies in the 
    /// </summary>
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected ISystemFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(ISystemFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into devPlatfom.
        /// </returns>
